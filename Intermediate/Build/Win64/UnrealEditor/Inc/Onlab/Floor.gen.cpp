...
#include "Onlab/Floor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeFloor() {}
// Cross Module References
	ONLAB_API UClass* Z_Construct_UClass_AFloor_NoRegister();
	ONLAB_API UClass* Z_Construct_UClass_AFloor();
...
// End Cross Module References
	...
	template<> ONLAB_API UClass* StaticClass<AFloor>()
	{
		return AFloor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AFloor);
	struct Z_CompiledInDeferFile_FID_Onlab_Source_Onlab_Floor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Onlab_Source_Onlab_Floor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFloor, AFloor::StaticClass, TEXT("AFloor"), &Z_Registration_Info_UClass_AFloor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFloor), 2218506965U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Onlab_Source_Onlab_Floor_h_3869294814(TEXT("/Script/Onlab"),
		Z_CompiledInDeferFile_FID_Onlab_Source_Onlab_Floor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Onlab_Source_Onlab_Floor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
